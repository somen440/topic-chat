...
export class AuthServiceClient {
  ...
  join(
    ...
    callback: (err: grpcWeb.Error, response: User) => void
  ) {
    return this.client_.rpcCall(
      this.hostname_ + "/topicchat.AuthService/Join",
      request,
      metadata || {},
      this.methodInfoJoin,
      callback
  ...
  loggedIn(
    ...
    return this.client_.rpcCall(
      this.hostname_ + "/topicchat.AuthService/LoggedIn",
      request,
      metadata || {},
  ...
  signout(
    ...
    return this.client_.rpcCall(
      this.hostname_ + "/topicchat.AuthService/Signout",
      request,
      metadata || {},
...
export class RoomServiceClient {
  ...
  join(
    ...
    return this.client_.rpcCall(
      this.hostname_ + "/topicchat.RoomService/Join",
      request,
      metadata || {},
      this.methodInfoJoin,
      callback
  ...
  left(
    ...
    return this.client_.rpcCall(
      this.hostname_ + "/topicchat.RoomService/Left",
      request,
      metadata || {},
      this.methodInfoLeft,
      callback
...
export class ChatServiceClient {
  ...
  recvMessage(request: Empty, metadata?: grpcWeb.Metadata) {
    return this.client_.serverStreaming(
      this.hostname_ + "/topicchat.ChatService/RecvMessage",
      request,
      metadata || {},
...
export class TopicCatalogServiceClient {
  ...
  listTopics(
    request: Empty,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error, response: ListTopicsResponse) => void
  ) {
    return this.client_.rpcCall(
      this.hostname_ + "/topicchat.TopicCatalogService/ListTopics",
      request,
      metadata || {},
  ...
  getTopic(
    request: GetTopicRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error, response: Topic) => void
  ) {
    return this.client_.rpcCall(
      this.hostname_ + "/topicchat.TopicCatalogService/GetTopic",
      request,
      metadata || {},
